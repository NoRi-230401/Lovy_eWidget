...
***************************************************************************************/
TraceWidget::TraceWidget(LGFX_Sprite* tft, GraphWidget *gw)
{
  _tft = tft;
  _gw = gw;
}

// This constructor is for convenience and backwards compatibility, the tft pointer is grabbed from the graph pointer
